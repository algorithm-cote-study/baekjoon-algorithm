...
import static org.backjoon.season1.class16.yeji.Main13144.solution;
...
class Main13144Test {
        ...
        void test_case_1() throws Exception {
                ...
                BufferedReader reader = TestFileUtil.getReader(this.getClass(),
                                "testcase/class16/13144/test_case1.txt");
                // when
        ...
        void test_case_2() throws Exception {
                // given
                BufferedReader reader = TestFileUtil.getReader(this.getClass(),
                                "testcase/class16/13144/test_case2.txt");
                // when
                long solution = solution(reader);
                // then
        ...
        void test_case_3() throws Exception {
                // given
                BufferedReader reader = TestFileUtil.getReader(this.getClass(),
                                "testcase/class16/13144/test_case3.txt");
                // when
                long solution = solution(reader);
                // then
